...
<body>
            ...
            <nav class="navbar fixed-top navbar-expand-lg navbar-light shadow-sm bg-white">
                ...
                <div class="collapse navbar-collapse justify-content-end me-5">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link myNavLink myNavLinkActive" type="link" href="registerPage.php"> Register</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link myNavLink" type="link" href="loginPage.php"> Login </a>
                        </li>
                    </ul>
                </div>
            </nav>
    ...
    <section class="container myContainer mt-5 pt-5" style="padding-top: 30px">
        <div class="d-flex justify-content-center">
            <span class="brand-text-icon text-navy fs-4">Register</span>
        </div>
        ...
        <div class="d-flex justify-content-center" style="height: 200px">
            ...
            <div class="section">
                <form action="../process/registerProcess.php" method="post">
                    ...
                    <div class="mb-3">
                        <span class="form-text">Already Have an Account?<a href="loginPage.php" class="text-navy"> Sign
                                In</a></span>
                    </div>
