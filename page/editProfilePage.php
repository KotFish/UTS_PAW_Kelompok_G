...
?>
    <section class="container myContainer mt-5 pt-5" style="padding-top: 30px">
        <div class="d-flex justify-content-center">
            <span class="brand-text-icon text-navy fs-4">Edit My Profile</span>
        </div>
        <div class="d-flex justify-content-center" style="margin-bottom: 30px">
            <span class="text-gray">Please edit the filled fields below</span>
        </div>
                ...
                <?php
                    ...
                    <form action="../process/editProfileProcess.php?id='.$id.'" method="POST">
                        <div class="mb-3">
                            ...
                            <input required class="form-control" id="username" name="username" aria-describedby="emailHelp" placeholder="Username" value="'.$data['username'].'">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input required type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="someone@example.domain" value="'.$data['email'].'">
                        </div>
